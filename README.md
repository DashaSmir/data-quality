...
- `CONCAT_WS` объединяет только не-NULL значения через запятую. В `WHERE` отбираем строки, где хотя бы одна ошибка.
...
## Задание 5
### Задание 5.1
- Данные таблицы order_sales (Рис. №8) и данные таблицы inventory_snapshots (Рис. №9). 
